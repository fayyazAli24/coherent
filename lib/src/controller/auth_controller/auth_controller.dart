...
class AuthController extends GetxController {
  ...
  Future<String?> signupService(String fullname, String email, String password, String mrNo, String emiratesId,
      String phoneNumber, String dob) async {
    try {
      isLoading.value = true;

      var response = await AuthService().signupService(fullname, email, password, mrNo, emiratesId, phoneNumber, dob);
      if (response != null) {
        isLoading.value = false;
