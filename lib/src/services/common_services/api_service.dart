...
class APIService {
  ...
  static Future<dynamic> signup(
      {required String api, Map<String, dynamic>? body}) async {
    try {
      var header = {
      ...
      final response = await http.post(
          headers: header, Uri.parse(api), body: jsonEncode(body));
  ...
  static Future<dynamic> post(
      {required String api, String? id, Map<String, dynamic>? body}) async {
    try {
      final token = await StorageServices().read(tokenKey);
      var header;
